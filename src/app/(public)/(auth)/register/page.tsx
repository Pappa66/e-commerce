    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-gradient-to-b from-emerald-50/30 to-white py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-3">Buat akun baru</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input id="name" value={name} onChange={e => setName(e.target.value)} required placeholder="Nama Anda" className="pl-9 rounded-xl" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} required placeholder="Min. 6 karakter" minLength={6} className="pl-9 rounded-xl" />
              </div>
            </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Sudah punya akun?{" "}
          <Link href="/login" className="text-emerald-600 font-medium hover:underline">Masuk</Link>
        </p>
      </div>
    </div>
  )
