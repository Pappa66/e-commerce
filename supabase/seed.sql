...
-- 3. Products (picsum.photos untuk placeholder random, konsisten per seed name)
...
(
  ...
  ARRAY['https://picsum.photos/seed/hijab-kalisha/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/gamis-zara/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/batik-athaya/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/mukena-travel/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/pashmina-ceruty/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/gamis-alisha/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/brooch-mutiara/600/600'],
...
(
  ...
  ARRAY['https://picsum.photos/seed/sajadah-travel/600/600'],
...
('Koleksi Hijab Terbaru', 'Tampil stylish dengan hijab modern kami, adem dan nyaman sepanjang hari', 'https://picsum.photos/seed/banner-hijab/1200/450', '/kategori/hijab', 1),
('Gamis Spesial Ramadan', 'Sambut bulan penuh berkah dengan gamis elegan dari koleksi terbaru', 'https://picsum.photos/seed/banner-gamis/1200/450', '/kategori/gamis', 2),
('Bebas Ongkir + COD', 'Nikmati belanja tanpa khawatir. Bayar di tempat dan gratis ongkir!', 'https://picsum.photos/seed/banner-promo/1200/450', '/search', 3);
